...
#include "../realm_test_fixture.hpp"

class RealmDeploymentTestFixture : public RealmTestFixture
{
};

TEST_F(RealmDeploymentTestFixture, OnSuccess)
{
  ...
  batch.reserve(buffer1.size() + buffer2.size());
