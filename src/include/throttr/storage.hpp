...
struct entry_wrapper {
  ...
  [[nodiscard]] request_key key() const {
    return {
        std::string_view(reinterpret_cast<const char*>(key_.data()),
                         key_.size()),  // NOSONAR
    };
  }
   ...
   * @param e
   */
  entry_wrapper(std::vector<std::byte> k, entry e)
      : key_(std::move(k)), entry_(std::move(e)) {}
};
    ...
    boost::multi_index::indexed_by<
        ...
        boost::multi_index::hashed_unique<
            ...
            boost::multi_index::composite_key<
                entry_wrapper,
                boost::multi_index::const_mem_fun<entry_wrapper,
                                                  request_key,
                                                  &entry_wrapper::key>,
                boost::multi_index::
                    member<entry_wrapper, bool, &entry_wrapper::expired_> >,
            boost::multi_index::composite_key_hash<request_key_hasher,
                                                   std::hash<bool> >,
        ...
        boost::multi_index::ordered_non_unique<
            ...
            boost::multi_index::
                member<entry_wrapper, entry, &entry_wrapper::entry_>,
